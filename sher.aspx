<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sher.aspx.cs" Inherits="sher" %>

<%@ Register Src="usercontrol/rightusercontrol.ascx" TagName="rightusercontrol" TagPrefix="uc4" %>
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td style="height: 538px" align="center" valign="top" width="500">
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Style="direction: rtl" Width="90%" AllowPaging="True" EnableTheming="True" HorizontalAlign="Center" CellPadding="4" ForeColor="#333333" GridLines="None" OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="20"  >
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Type" HeaderText="‰Ê⁄" />
                                        <asp:HyperLinkField DataNavigateUrlFields="SPath" DataTextField="Envan" HeaderText="⁄‰Ê«‰" />
                                    </Columns>
                            ...
                            <td align="right" style="height: 538px" valign="top" width="150">
                                <uc4:rightusercontrol ID="Rightusercontrol1" runat="server" />
                                &nbsp;</td>
                        </tr>
                    </table>
                </td>
